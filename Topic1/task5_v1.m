...
while ~allflag
    ...
    if ~sent(ST)
        ...
        alltarget = ST;
        rdata(ST) = 1;% 避免ST节点回传,需要rdata(ST) = 1来去掉1跳的前序
        sent(ST) = 1;
    else
