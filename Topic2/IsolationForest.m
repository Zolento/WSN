...
for i = 1:NumTree
    ...
    if NumSub < NumInst % randomly selected sub-samples 生成NumInst/DimInst个随机数，采样，并从小到大排序
    ...
    Forest.Trees{i} = IsolationTree(Data, IndexSub, 0, Paras); % build an isolation tree 生成孤立树
    
end

Forest.ElapseTime = cputime - et; % 森林的建立时间
